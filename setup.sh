...
#
# 安装内容：
# - 根目录 CLAUDE.md（HARNESS_PHILOSOPHY.md 留模板仓，不分发到下游项目）
...
# HARNESS_PHILOSOPHY.md 留在模板仓，不分发到下游：
# 设计哲学是单一真相源，分发会导致下游版本随时间漂移。
# 需要时去模板仓 README 顶部链接查阅即可。
...
echo ""
echo "想理解设计理念 → 看模板仓 HARNESS_PHILOSOPHY.md（不分发，单一真相源）"
echo ""
